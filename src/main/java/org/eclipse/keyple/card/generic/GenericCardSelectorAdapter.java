 ...
 * @since 2.0
 */
public final class GenericCardSelectorAdapter implements CardSelectorSpi, CardSelector {
  ...
  /**
   * Builder of {@link GenericCardSelectorAdapter}.
   *
   * @since 2.0
   */
  public static final class Builder {
    ...
    /**
     * Creates an instance of {@link GenericCardSelectorAdapter}.
     *
     * @return A not null reference.
     * @since 2.0
     */
    public CardSelector build() {
      return new GenericCardSelectorAdapter(this);
    }
  }

  /**
   * (private)<br>
   * Created an instance of {@link GenericCardSelectorAdapter}.
   *
   * @param builder The {@link Builder}.
   */
  private GenericCardSelectorAdapter(Builder builder) {
  ...
  /**
   * Creates builder to build a {@link GenericCardSelectorAdapter}.
   *

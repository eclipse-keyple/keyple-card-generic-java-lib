| Version | Documents |
|:---:|---|
| 3.2.0-SNAPSHOT | [API documentation](3.2.0-SNAPSHOT)<br>[API class diagram](3.2.0-SNAPSHOT/api_class_diagram.svg) |
| **3.1.3 (latest stable)** | [API documentation](latest-stable)<br>[API class diagram](3.1.3/api_class_diagram.svg) |
